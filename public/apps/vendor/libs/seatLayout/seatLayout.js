...
(function ($) {
    ...
    function Movieseat(_paramObject) {
        ...
        var getMainLayoutFunc = function (_obj) {
            ...
            _html += "<div class='movie-screen " + pluginOptions.classes.screen + "'>-- Stage --</div>" + actionPanel + "</div>";
            return _html;
        };

        // Function to get area layout HTML
        var getAreaLayoutFunc = function (_obj) {
            ...
            // Add column numbering with a blank li at first
            var columnNumbering = getColumnNumbering(_obj.objRow[0].objSeat.length);
            var blankLi = "<li class='seat-row-seat' style='width:19px;'>&nbsp;</li>";
            _html += "<ul class='seat-area-row'>" + blankLi + columnNumbering + "</ul>";
        ...
        // Function to get column numbering HTML
        var getColumnNumbering = function (numColumns) {
            var numberingHtml = "";
            for (var i = 0; i < numColumns; i++) {
                numberingHtml += "<span class='seat-row-seat'>" + (i + 1) + "</span>";
            }
            return numberingHtml;
        };

        // Function to get row layout HTML
        ...
        // Function to get seat layout HTML
