...
document.addEventListener("DOMContentLoaded", function (e) {
    ...
    (t = document.getElementById("form-add-new-record")),
        ...
        (fv = FormValidation.formValidation(t, {
            fields: {
                ...
                basicEmail: { validators: { notEmpty: { message: "The Email is required" }, emailAddress: { message: "The value is not a valid email address" } } },
                basicDate: { validators: { notEmpty: { message: "Joining Date is required" }, date: { format: "MM/DD/YYYY", message: "The value is not a valid date" } } },
    ...
    $(function () {
        ...
        fv.on("core.form.valid", function () {
            ...
            "" != e && (l.row.add({ id: r, full_name: e, post: t, email: a, start_date: s, salary: "$" + n, status: 5 }).draw(), r++, offCanvasEl.hide());
        }),
