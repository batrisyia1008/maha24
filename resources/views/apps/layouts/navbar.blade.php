            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                ...
                <div class="navbar-nav align-items-center">
                    <div class="nav-item navbar-search-wrapper mb-0">
                        ...
                        @hasanyrole(['vendor'])
                        <a class="nav-item nav-link d-flex align-items-center px-0 d-sm-block d-none" href="javascript:void(0);">
                            <img src="{{ asset('apps/img/nexes_01.png') }}" alt="" class="w-px-150 d-sm-block d-none">
                            <img src="{{ asset('apps/img/nexes_01.png') }}" alt="" class="img-fluid d-sm-none d-block">
                        </a>
                        @endhasanyrole
                    </div>
                </div>
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 me-3">
                                                <div class="avatar">
                                                    <img src="{{ asset('apps/img/avatars/2.png') }}" alt class="h-auto rounded-circle">
                                                </div>
                                            </div>
                                            <div class="flex-grow-1">
                                    ...
                                    <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 me-3">
                                                <div class="avatar">
                                                    <img src="{{ asset('apps/img/avatars/9.png') }}" alt class="h-auto rounded-circle">
                                                </div>
                                            </div>
                                            <div class="flex-grow-1">
                                    ...
                                    <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 me-3">
                                                <div class="avatar">
                                                    <img src="{{ asset('apps/img/avatars/5.png') }}" alt class="h-auto rounded-circle">
                                                </div>
                                            </div>
                                            <div class="flex-grow-1">
                                    ...
                                    <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 me-3">
                                                <div class="avatar">
                                                    <img src="{{ asset('apps/img/avatars/6.png') }}" alt class="h-auto rounded-circle">
                                                </div>
                                            </div>
                                            <div class="flex-grow-1">
