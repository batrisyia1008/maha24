...
@push('script')
    ...
    $(document).ready(function() {
      ...
      flatpickr("#datePicker", {
        ...
        //         $('#ba').append(`<option value="${zone.id}">${zone.name}</option>`);
        //     });
        // });

        // Function to fetch and update visitors and spending
    //     function fetchVisitorsAndSpending() {
    //         let zoneId = $('#zone-dropdown').val();
    //         let startDate = $('#start-date').val();

    //         // Only fetch data if a zone is selected
    //         if (!zoneId) {
    //             return; // No zone selected, don't proceed
    //         }

    //          // Make the AJAX call to fetch visitors and spending
    //     $.ajax({
    //         url: '/api/visitors-and-spending',
    //         method: 'POST',
    //         data: {
    //             zone_id: zoneId,
    ...
    //             $('#total-visitors').text(response.total_visitors);
    //             $('#total-spending').text(response.total_spending);
    //         },
    ...
    // // Trigger fetch when zone or date is changed
    // $('#zone-dropdown').on('change', fetchVisitorsAndSpending);
    // $('#start-date').on('change', fetchVisitorsAndSpending);
